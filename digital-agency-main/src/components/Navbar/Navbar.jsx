...
import Logo from "../../assets/website/we bee logo.jpg";
    ...
    <div className="relative z-10 w-full dark:bg-black dark:text-white duration-300">
      <div className="container py-3 md:py-2">
        <div className="flex justify-between items-center">
          ...
          >
            <img src={Logo} alt="" className="w-20" /> {/* Adjusted size */}
            <span className="text-2xl sm:text-3xl font-semibold">We Bee</span>
          </a>
